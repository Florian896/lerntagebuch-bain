...
Lerntagebuch
	...
	ein Eintrag pro halbtag
		plus ein paar, die er sagt
	Zeichen gezählt MIT Leerzeichen
	s.Moodle / Dokument



Bild auf Dok --> Flowchart
OpenRefine für Tabellen (ev s. nach Pause ca 1h30 in Aufnahme)
Modul läuft von links nach rechts
...
- wie funzt
- kann präsi
- öffentlich, nicht privat. Einstellungen
- (Datei Upload)
