...
Für einige Stunden pro Monat, kann das gratis verwendet werden. 
Will man jedoch mehr damit arbeiten, benötigt man ein kostenpflichtiges Konto.


DELETE ALL FROM HERE ON WHEN DONE
Outline / Plan for next topics: ~~GitHub~~, CodeSpaces, Kommandozeile (vertiefen, befehle, man, grep, ev exkurs regex golf)
